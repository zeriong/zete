...
// import { CreateAccountDto } from '../user/dtos/createAccount.dto';
...
//   ) {}
//   async createMemo(input): Promise<CoreOutput> {
//     try {
//       const user = await this.memoRepository.findOne()
//       const exists = await this.memoRepository.findOne({
//         where: [{ userId:  }],
//       });
//       if (exists) {
//         return {
