        ...
        <>
            ...
            >
                <section
                    ...
                    : 'border border-zete-light-gray-500 rounded-[8px] bg-memo'}`}
                >
                        ...
                        />
                            {formMode === 'idle' && (
                                <>
                                    ...
                                    <button
                                        type='button'
                                        className={`block md:hidden text-[12px] rounded-[8px] font-normal text-white border-2 border-zete-gpt-200 bg-gpt py-[4px] px-[8px] whitespace-nowrap`}
