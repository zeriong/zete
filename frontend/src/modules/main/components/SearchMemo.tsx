...
export const SearchMemo = () => {
    ...
    return (
        <form
            ...
            onBlur={handleSubmit}
            className='flex items-center flex-row-reverse md:flex-row w-[170px] md:w-[260px] px-[10px] py-[4px] text-[14px] md:border md:border-zete-light-gray-500
            bg-zete-md-placeHolder md:bg-white rounded-[4px] ml-[10px] md:m-0'
        >
