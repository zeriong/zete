...
import {setShowSideNavReducer, toggleSideNavReducer} from '../../../store/layout/layout.slice';
...
export const HomeNav = ()=> {
    ...
    const logout = async () => {
        await logoutAction();
        dispatch(setShowSideNavReducer(false));
    }
    ...
    return !userState.loading &&
        <nav className='flex justify-between h-[48px] md:h-auto pl-[12px] pr-[12px] items-center md:px-[40px] py-[12px] border-b border-gray-300 whitespace-nowrap fixed bg-white w-full z-30'>
            <div
                onClick={ () => dispatch(setShowSideNavReducer(false)) }
